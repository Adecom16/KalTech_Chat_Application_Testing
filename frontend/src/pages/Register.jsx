      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className={`mt-2 ${darkMode ? 'text-katech-dark-muted' : 'text-katech-light-muted'}`}>Create your account</p>
          </div>
          ...
          <div className={`rounded-2xl shadow-2xl p-8 border ${darkMode ? 'bg-katech-dark-surface border-katech-dark-border' : 'bg-katech-white border-katech-light-border'}`}>
            <h2 className={`text-xl font-semibold mb-6 text-center ${darkMode ? 'text-katech-white' : 'text-katech-black'}`}>Get Started</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-katech-dark-muted' : 'text-katech-light-muted'}`}>Full Name</label>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-katech-dark-muted' : 'text-katech-light-muted'}`}>Confirm Password</label>
                <input
                  type="password"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-katech-gold hover:bg-katech-gold-dark text-katech-black rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2"
              >
                {loading ? (
            ...
            <p className={`text-center mt-6 ${darkMode ? 'text-katech-dark-muted' : 'text-katech-light-muted'}`}>
              ...
              <Link to="/" className="text-katech-gold font-semibold hover:text-katech-gold-dark transition-colors">
                Sign In
              </Link>
            </p>
          </div>
